      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <span className="text-3xl font-bold text-gradient">Chance AI</span>
          </div>
        ...
        <div className="glass-strong rounded-2xl p-8 shadow-card">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full gradient-hero text-white border-0 h-12 text-base font-medium shadow-glow hover:opacity-90 transition-opacity"
            >
              {loading ? (
